...
{% set WIDTH_REGION, WIDTH_STRIP = 110, 85 %}
  ...
  <table class="table" style="width:575px;">
    <thead>
      ...
      <tr>
        ...
        <th class="text-left" colspan="2" style="width:{{ WIDTH_STRIP }}px;">New Cases</th>
        <th class="text-left" colspan="2" style=""width:{{ WIDTH_STRIP }}px;">Total Cases</th>
        <th class="text-left" colspan="2" style=""width:{{ WIDTH_STRIP }}px;">Deaths</th>
        <th class="text-left" colspan="2">Fatality</th>
      </tr>
    </thead>
    <tbody>
